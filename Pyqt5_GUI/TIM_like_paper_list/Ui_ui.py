...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(255, 678)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("res/logo.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)  # 左上角的logo
        ...
        #  ======= 上方横栏
        self.horizontalLayout = QtWidgets.QHBoxLayout()  # 上方横栏
        self.horizontalLayout.setObjectName("horizontalLayout")

        self.lineEdit = QtWidgets.QLineEdit(Form)  # 搜索框
        self.lineEdit.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.lineEdit.setObjectName("lineEdit")
        self.horizontalLayout.addWidget(self.lineEdit)

        self.bt_search = QtWidgets.QToolButton(Form)  # 搜索按钮
        icon1 = QtGui.QIcon()
        ...
        self.bt_adduser = QtWidgets.QToolButton(Form)  # 添加按钮
        icon2 = QtGui.QIcon()
    ...
    def retranslateUi(self, Form):  # 一些tip
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "学点编程吧--TIM模拟"))
